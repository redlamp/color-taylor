...
![The Color Taylor app icon and name beside the hexagon, a six-cornered color field with red, green and blue vectors drawn across it, and the words "Play with different color models, see how they move together! Get hands-on with how RGB, HSB, and HSL colors relate."](figma/brand/thumbnail-1200x675.jpg)
