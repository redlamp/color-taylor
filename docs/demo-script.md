...
occupy: left edge on the lowest value, right edge on the highest, top and
bottom on the R and B tracks, padded 8 px — for a `live` `rect`),
`hex-sat`, `hex-bri`,
