...
- [[decision-all-html-colours-on-the-field]] — all 141 named colours on the hexagon's field at once, each at its own hue and saturation, faded by its distance in brightness from the current value
